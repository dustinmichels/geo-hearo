        ...
        >
          ...
          <div class="space-y-2">
            <div
              ...
              :key="idx"
              class="grid grid-cols-[1fr_auto_auto] gap-3 items-center text-sm bg-paper-white/50 p-2 rounded-lg border border-pencil-lead/5"
            >
              <span class="font-bold text-pencil-lead truncate">{{
                item.country
              }}</span>
              <span class="tracking-widest">{{ item.score }}</span>
              <span
                class="font-mono font-bold text-pencil-lead/70 w-6 text-right"
                >{{ getScore(item) }}</span
              >
            </div>
          </div>
