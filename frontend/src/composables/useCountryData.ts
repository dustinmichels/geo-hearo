...
const adminToFeature = ref<Map<string, Feature<Geometry, NeCountryProperties>>>(new Map());
...
export function useCountryData() {
  ...
  const getFeature = (countryAdmin: string): Feature<Geometry, NeCountryProperties> | undefined => {
